                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('streetName') ? ' has-error' : '' }}">
                            <label for="streetName" class="col-md-4 control-label">Streetname</label>
                        ...
                        <div class="form-group{{ $errors->has('houseNumber') ? ' has-error' : '' }}">
                            <label for="control" class="col-md-4 control-label">Number</label>

                            <div class="col-md-6">
                                <input id="houseNumber" type="text" class="form-control" name="houseNumber" value="{{ old('houseNumber') }}" required autofocus>
